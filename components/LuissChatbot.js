...
const CHATBOT_USER_OBJ = {
  ...
  avatar: require("../assets/luis-amongus.jpg"),
};

const words = [
    "apple", "banana", "cherry", "dog", "cat", "elephant", "giraffe", "lion", "tiger", "bear",
    "car", "bicycle", "airplane", "train", "bus", "computer", "laptop", "tablet", "phone", "keyboard",
    "mouse", "chair", "table", "lamp", "book", "pencil", "notebook", "backpack", "shoes", "shirt",
    "pants", "hat", "gloves", "sock", "belt", "jacket", "watch", "glasses", "ring", "necklace",
    "pizza", "burger", "pasta", "salad", "soup", "steak", "sandwich", "fries", "hotdog", "taco",
    "canada", "mexico", "brazil", "argentina", "china", "japan", "india", "australia", "germany", "france",
    "spain", "italy", "russia", "egypt", "southafrica", "kenya", "nigeria", "ghana", "ethiopia", "morocco",
    "rose", "tulip", "sunflower", "daisy", "lily", "orchid", "daffodil", "poppy", "lavender", "carnation",
    "spoon", "fork", "knife", "plate", "cup", "bowl", "pot", "pan", "oven", "microwave",
    "google","apple","microsoft","amazon","facebook","intel","cisco","oracle","dell","nvidia","samsung","sony",
    "panasonic","toshiba","lenovo","qualcomm","adobe","salesforce","paypal","shopify","netflix","uber",
    "lyft","spotify","twitter","snap","zoom","tiktok","wechat","dropbox","box","github","fastly","snowflake",
    "slack","discord","telegram","kraken","stripe","workday","logitech","fitbit","pandora",
    "blizzard", "nintendo","activision","epicgames","roblox", "amongus",  "sleep", "write", "dance", "study", "drive", 
    "build", "create", "think", "walk", "climb", "paint", "smile", "laugh", "fight", "argue",
    "clean", "travel", "solve", "teach", "learn","program", "dance", "swim",  "bewilderment","chrysanthemum",
    "exacerbate","inconceivable","juxtaposition","obfuscation","quintessential","transcendental","unfathomable",
    "vexatious", "pikachu", "cheeto", "engineering", "design", "storytelling", "lens"
  ];
