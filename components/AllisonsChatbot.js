...
const trivia = [
  {
      "question": "What is one of Snap's core values? (answer is a string)",
      "answer": "kind, smart, creative"
  },
  {
      "question": "What is 4 times 6? (answer is an integer)",
      "answer": "24"
  },
  {
      "question": "Earth has a population of over 8 billion people. (answer is true or false)",
      "answer": "true"
  }
]
...
export default function App() {
  ...
  const respondToUser = (userMessages) => {
    ...
    if (!userReady && userMessages[0].text.toLowerCase() != 'go') { // user is not ready and has not said go
      ...
      if (userMessages[0].text.toLowerCase() === trivia[questionCounter].answer || userMessages[0].text === trivia[questionCounter].answer || trivia[questionCounter].answer.includes(userMessages[0].text.toLowerCase())) {
